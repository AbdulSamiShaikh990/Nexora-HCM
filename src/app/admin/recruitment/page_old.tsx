...
export default function RecruitmentPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-gray-700">Manage job postings and hiring pipeline with AI-powered assessments.</p>
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <a href="/admin/recruitment/applications" className="block rounded-xl border border-white/30 bg-white/60 backdrop-blur shadow-sm hover:bg-white/80 transition">
          <div className="p-4">
            ...
            <div className="text-sm text-gray-700">Review and manage applications</div>
          </div>
        </a>
        <a href="/admin/recruitment/pipeline" className="block rounded-xl border border-white/30 bg-white/60 backdrop-blur shadow-sm hover:bg-white/80 transition">
          <div className="p-4">
            <div className="text-lg font-semibold text-gray-900">⚡ Pipeline</div>
            <div className="text-sm text-gray-700">Track hiring progress</div>
          </div>
        </a>
        <a href="/admin/recruitment/analytics" className="block rounded-xl border border-white/30 bg-white/60 backdrop-blur shadow-sm hover:bg-white/80 transition">
          <div className="p-4">
            <div className="text-lg font-semibold text-gray-900">📊 Analytics</div>
            <div className="text-sm text-gray-700">View recruitment insights</div>
          </div>
        </a>
      </div>
